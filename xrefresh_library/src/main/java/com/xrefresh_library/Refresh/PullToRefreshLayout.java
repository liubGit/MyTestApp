...
public class PullToRefreshLayout extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        this.triggerOffset = context.getResources().getDimensionPixelOffset(R.dimen.refresh_trigger_offset);
    }
    ...
    protected void onFinishInflate() {
        ...
        if (this.getChildCount() > 1) {
            ...
            this.refreshHead = (RefreshHeader) LayoutInflater.from(this.getContext()).inflate(R.layout.default_header, this, false);
