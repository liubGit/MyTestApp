...
public class XScrollView extends ScrollView {
    ...
    protected void setOnScrollListener(XRefreshListView parent, OnScrollListener scrollListener) {
        mParent = parent;
        this.onScrollListener = scrollListener;
        mParent.addTouchLifeCycle(new XRefreshListView.TouchLifeCycle() {
            @Override
