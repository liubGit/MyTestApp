...
import com.xrefresh_library.Refresh.base.RecyclerViewDataObserver;
 ...
 */
public abstract class BaseXRecyclerAdapter<VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> {
    ...
    public void onAttachedToRecyclerView(RecyclerView recyclerView) {
        ...
        if (parent != null && parent instanceof XRefreshListView) {
            mParent = (XRefreshListView) recyclerView.getParent();
